...
//////////////////////////////////////////////////////////////////////////////////////
	...
	/*!
		\brief 		Operador de igualdad: comprueba si un Monomio "m1" es igual
					a otro Monomio "m2" (m1==m2)
		...
		\pre 		Ninguna 
		\post 		El valor devuelto (bool valorDevuelto) es el resultado lógico de 
					de la comparación del coeficiente y el grado ((m1.getGrado() == m2.getGrado())
					and (m1.getCoeficiente() == m2.getCoeficiente))
